...
class Scr:
    def __init__(self):
        ...
        self.button0 = False
        self.button1 = False
        self.function_input = "math.sin(x)"  # fonsiyon girişi sadece 
    ...
    def draw_function(self):
        ...
        for _ in range(-WIDTH,WIDTH):
            x=  _+ self.width-self.x
            try:
                y = eval(self.function_input.replace("x", str(x / 100))) * 100 
                if 0<self.height-self.y-y < HEIGHT:
